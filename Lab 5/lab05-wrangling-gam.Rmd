...
```{r}
# 2) Calculate the euclidean distance between lat and lon
mid[, mid_eudist := 
              sqrt((lon - lon_50)^2 + (lat - lat_50)^2)]

# 3) Find the closest stattion to the mid-point of state
...
# Calculate the overall average temperature per state
