...
met_avg |> 
  ...
  ggplot() +
  geom_violin(mapping = aes(x = 1, y=dew.point, color=region)) +
  facet_wrap(~region, nrow=1) + 
  labs(
   x = "Region",
   y = "Dew point",
...
met_avg |> 
  ...
  labs(
   x = "Wind Speed",
   y = "Dew Point",
   title="Association between Wind Speed and Dew Point by Region"
  )
...
- Dew point temperature is around 10 to 25 degree celcius.
- Wind speed is around 1.5 to 4.
